...
export const engine = new Engine([
  createInfiniteSource("NaOH sol. 10%", { NaOH_aq: 0.3, H2O: 0.7 }, 2, 4, "#ffbdbd", "/design/300x300/subst_inf_baza_302_440.png"),
  createInfiniteSource("HCl sol. 10%", { HCl_aq: 0.3, H2O: 0.7 }, 2, 32, "#b6ffd0","/design/300x300/subst_inf_acid_302_440.png"),
